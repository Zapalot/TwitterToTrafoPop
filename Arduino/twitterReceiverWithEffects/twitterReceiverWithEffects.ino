...
/////!!!!DANGER!!!! using the wrong pin might lock you out of your SIM-Card!!!!!
#define totalCurrentLimit 1000 // maximum current we allow the leds to draw when they are all white
#define nTotalLeds 200  //the number of LEDs on your jacket
...
LedInterface leds;            // keeps a buffer of pixel colors and talks with the leds
